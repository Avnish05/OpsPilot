...
public class AlertEventProcessor {
    ...
    public AlertEventProcessor(ProcessedEventRepository processedEvents, IncidentFacade incidents, Validator validator, Clock clock) {
    ...
    public boolean process(AlertReceivedEvent event) {
        ...
        if (processedEvents.existsById(event.eventId())) return false;
